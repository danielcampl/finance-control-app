    ...
    <div className="grid grid-cols-3 gap-4 mb-2">
      ...
      <div className="bg-green-100 p-4 rounded-xl shadow-md flex flex-col justify-center items-center md:items-baseline md:justify-normal">
        <div className="flex items-center gap-2 text-green-700">
          ...
          <h4 className="text-xs md:text-xl font-semibold">Entrada</h4>
        </div>
        <p className="text-xs md:text-xl font-bold mt-2">{formatCurrency(income)}</p>
      </div>
      ...
      <div className="bg-red-100 p-4 rounded-xl shadow-md flex flex-col justify-center items-center md:items-baseline md:justify-normal">
        <div className="flex items-center gap-2 text-red-700">
          ...
          <h4 className="text-xs md:text-xl font-semibold">Saída</h4>
        </div>
        <p className="text-xs md:text-xl font-bold mt-2">{formatCurrency(expense)}</p>
      </div>
      ...
      <div className="bg-blue-100 p-4 rounded-xl shadow-md flex flex-col justify-center items-center md:items-baseline md:justify-normal">
        <div className="flex items-center gap-2 text-blue-700">
          ...
          <h4 className="text-xs md:text-xl font-semibold">Total</h4>
        </div>
        <p className="text-xs md:text-xl font-bold mt-2">{formatCurrency(total)}</p>
      </div>
    </div>
  );
}
